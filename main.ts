...
let countriesToVisit:string[]=["china","America","Brazile","London","France"];
...
let lengthGuest:number= guestList0.length;
...
let magicians: string[] = ['Harish', 'Daood', 'faris', 'Taslim', 'Danish'];
...
// Array of magician's names
let magicians1: string[] = ['Harish', 'Daood', 'faris', 'Tanveer', 'Danial'];
...
// Array of magician's names
let magicians2: string[] = ['Hadi', 'farooq', 'sad', 'Tasleem', 'Danial'];
